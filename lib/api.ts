...
import { UniversityRegisterRequest } from '@/types/legacy-auth';
import { legacyUniversityEndpoints } from '@/lib/api/legacyUniversityEndpoints';
...
class ApiClient {
  ...
  // Ensure multipart requests keep browser-generated boundaries.
  ...
  return legacyUniversityEndpoints.registerUniversity(this.client, data);
  }
  ...
  return legacyUniversityEndpoints.verifyOtpAndRegisterUniversity(this.client, code, data);
  }
  ...
  // Legacy university compatibility methods.
  // New usage should prefer: `lib/api/legacyUniversity.ts` (re-exported by `services/legacy/universityApi.ts`).
  ...
  return legacyUniversityEndpoints.getUniversityApplications(this.client, params);
  }
  ...
  return legacyUniversityEndpoints.exportUniversityApplications(this.client, params);
  }
  ...
  return legacyUniversityEndpoints.updateUniversityApplicationStatus(
  this.client,
  applicationId,
  status,
  notes,
  ...
  return legacyUniversityEndpoints.getUniversityProfile(this.client);
  }

  async updateUniversityProfile(data: any): Promise<any> {
  return legacyUniversityEndpoints.updateUniversityProfile(this.client, data);
  }

  // University endpoints
  async getUniversityDashboard(): Promise<any> {
  return legacyUniversityEndpoints.getUniversityDashboard(this.client);
  }
  ...
  return legacyUniversityEndpoints.getUniversityStudents(this.client, includeArchived);
  }

  async createStudent(studentData: any): Promise<any> {
  return legacyUniversityEndpoints.createStudent(this.client, studentData);
  }

  async bulkCreateStudents(studentsData: any[]): Promise<any> {
  return legacyUniversityEndpoints.bulkCreateStudents(this.client, studentsData);
  }

  async uploadStudentsCSV(file: File): Promise<any> {
  return legacyUniversityEndpoints.uploadStudentsCSV(this.client, file);
  }

  async getStudentTemplate(): Promise<any> {
  return legacyUniversityEndpoints.getStudentTemplate(this.client);
  }

  async archiveStudent(studentId: string, archive: boolean = true): Promise<any> {
  return legacyUniversityEndpoints.archiveStudent(this.client, studentId, archive);
  }

  async deleteStudent(studentId: string): Promise<any> {
  return legacyUniversityEndpoints.deleteStudent(this.client, studentId);
  }


  // University job management endpoints
  async getUniversityJobs(): Promise<any> {
  return legacyUniversityEndpoints.getUniversityJobs(this.client);
  }
  ...
  return legacyUniversityEndpoints.approveUniversityJob(this.client, jobId);
  }

  async rejectUniversityJob(jobId: string): Promise<any> {
  return legacyUniversityEndpoints.rejectUniversityJob(this.client, jobId);
  }

  async createUniversityJob(jobData: any): Promise<any> {
  return legacyUniversityEndpoints.createUniversityJob(this.client, jobData);
  }

  async updateJobUniversity(jobId: string, jobData: any): Promise<any> {
  return legacyUniversityEndpoints.updateJobUniversity(this.client, jobId, jobData);
  }

  async deleteJobUniversity(jobId: string): Promise<any> {
  return legacyUniversityEndpoints.deleteJobUniversity(this.client, jobId);
  }

  async getAppliedStudentsUniversity(jobId: string): Promise<any> {
  return legacyUniversityEndpoints.getAppliedStudentsUniversity(this.client, jobId);
  }
  ...
  return legacyUniversityEndpoints.getUniversityLicenses(this.client);
  }

  async checkBatchEligibility(batch: string, degree?: string | string[], branches?: string[]): Promise<any> {
  return legacyUniversityEndpoints.checkBatchEligibility(this.client, batch, degree, branches);
  }

  async getUniversityLicenseRequests(): Promise<any> {
  return legacyUniversityEndpoints.getUniversityLicenseRequests(this.client);
  }
