...
export function Footer({ plainText = false, hideIcons = false }: FooterProps) {
  ...
  <li>
  <Link href="/signup" className="text-sm text-slate-600 transition-colors hover:text-blue-600 dark:text-blue-300 dark:hover:text-white">
  ...
  <ul className="flex flex-col items-center space-y-4 md:items-start">
  <li>
  <Link href="/signup" className="text-sm text-slate-600 transition-colors hover:text-blue-600 dark:text-blue-300 dark:hover:text-white">Find Jobs</Link>
  </li>
  <li>
