    ...
    <section id="how-it-works" className="scroll-mt-24 bg-muted/30 py-16 md:py-24 dark:bg-muted/5">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2 lg:gap-10">
          ...
          >
            <div className="mb-8">
              <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">For talent</p>
          ...
          >
            <div className="mb-8">
              <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">For hiring teams</p>
