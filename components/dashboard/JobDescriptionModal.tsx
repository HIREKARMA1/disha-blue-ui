        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="max-h-[92vh] w-full max-w-5xl overflow-hidden rounded-3xl border border-border/80 bg-card shadow-[0_32px_120px_-40px_hsl(var(--primary)/0.45)]"
                    onClick={(e) => e.stopPropagation()}
                >
                    <div className="flex max-h-[92vh] flex-col lg:max-h-[90vh] lg:flex-row">
                        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
                            <div className="border-b border-border/80 bg-gradient-to-br from-primary/[0.09] via-background to-secondary/[0.08] px-5 py-5 sm:px-7 sm:py-6">
                        ...
                        <aside className="flex w-full shrink-0 flex-col gap-4 border-t border-border/80 bg-muted/20 p-5 sm:p-6 lg:max-w-[320px] lg:border-l lg:border-t-0">
                            ...
                            <div className="rounded-2xl border border-dashed border-primary/35 bg-primary/[0.05] p-4">
                            ...
                            {showApplyButton && (
                                <Button
                                    type="button"
                                    variant="gradient"
                                    className="mt-auto hidden h-12 w-full rounded-xl font-semibold shadow-lg shadow-primary/20 lg:flex"
                                    onClick={onApply}
                    ...
                    <div className="border-t border-border/80 bg-muted/15 p-4 sm:p-5">
                        <div className="flex flex-col items-stretch justify-end gap-3 sm:flex-row sm:items-center">
                            ...
                            {showApplyButton && (
                                <Button
                                    ...
                                    disabled={!canApply() || isApplying}
                                    className={cn(
                                        'h-11 rounded-xl font-semibold shadow-md shadow-primary/15 lg:hidden',
                                        !canApply() && 'opacity-50',
                                    )}
                                >
