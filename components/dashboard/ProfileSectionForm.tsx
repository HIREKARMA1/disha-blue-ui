        ...
        if (field.includes('bio') || field.includes('experience') || field.includes('details') || field.includes('activities')) {
            return (
                <Textarea
                    ...
                    placeholder={`${t(locale, 'profile.form.enterYour')} ${field.replace(/_/g, ' ')}`}
                />
            )
        }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">{t(locale, 'profile.form.updateSectionInfoPrefix')} {section.title.toLowerCase()} {t(locale, 'profile.form.updateSectionInfoSuffix')}</p>
                </div>
            </div>
