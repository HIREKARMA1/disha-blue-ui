...
import { cn } from '@/lib/utils'// Industry options
...
const errors: Record<string, string> = {}
 ...
 errors.description ='Job description is required'} else if (formData.description.length < 10) {
 ...
 modeOfWork ='hybrid'} else if (formData.onsite_office) {
 modeOfWork ='onsite'} else if (formData.remote_work) {
 modeOfWork ='remote'}
...
const jobData: any = {
 ...
 Structured sections below—same submit flow, clearer hierarchy for recruiters.
 </p>
 </div>
 <Button
 ...
 Add state, district, and city/town for stronger local discovery in job search.
 </p>
