                            ...
                            <aside className="space-y-4 lg:col-span-3">
                                ...
                                <div className={`${corporateSurfaceClass} p-4`}>
                                    ...
                                    <div className="mt-3 space-y-2">
                                        <button onClick={() => setActiveTab('company')} className="w-full rounded-lg border border-border/70 px-3 py-2 text-left text-sm text-foreground transition hover:bg-muted/50">Update company details</button>
                                        <button onClick={() => setEditing('basic')} className="w-full rounded-lg border border-border/70 px-3 py-2 text-left text-sm text-foreground transition hover:bg-muted/50">Refresh branding info</button>
                                        <button onClick={() => setEditing('company')} className="w-full rounded-lg border border-border/70 px-3 py-2 text-left text-sm text-foreground transition hover:bg-muted/50">Refine about section</button>
                                    </div>
                                </div>
                                <div className={`${corporateSurfaceClass} p-4`}>
                ...
                <div className={`${corporateHeroClass} mb-6`}>
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div className="min-w-0 flex-1">
                            <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-primary/80">Company</p>
                        ...
                        <div className="shrink-0 rounded-full border border-border/80 bg-background/70 px-3 py-1 text-xs font-medium text-muted-foreground backdrop-blur-sm">
                                    ...
                                    <nav className="-mb-px flex space-x-6 overflow-x-auto">
                                        {tabs.map((tab) => (
                                            <button
                                                ...
                                                className={cn(
                                                    "flex items-center space-x-2 py-3 px-1 border-b-2 text-sm font-semibold transition-colors duration-200",
                                                    activeTab === tab.id
