...
export function CreateCorporateModal({
 ...
 <span className="text-sm font-medium text-gray-900">{createdCorporate?.email}</span>
 </div>
 <div className="flex justify-between">
 <span className="text-sm text-gray-600">Password:</span>
 <span className="text-sm font-medium text-gray-900">{createdCorporate?.temporary_password ||'Password@123'}</span>
 </div>
 </div>
 </div>
