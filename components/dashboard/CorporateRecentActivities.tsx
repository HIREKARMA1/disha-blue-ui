    ...
    return (
        ...
        >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
                ...
                <button type="button" className="text-sm font-medium text-primary hover:text-primary/80 flex items-center space-x-1 transition-colors">
                    <span>View All</span>
            ...
            <div className="space-y-4 blur-sm pointer-events-none">
                {mockActivities.map((activity, index) => (
                    <motion.div
                        ...
                        className="flex items-start space-x-3 p-3 rounded-xl border border-transparent hover:border-border/80 hover:bg-muted/30 transition-all cursor-default group"
                    >
