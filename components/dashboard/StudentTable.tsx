...
const fullProfile = {
 ...
 <tr>
 <th
 className="cursor-pointer px-6 py-4 text-left text-xs font-medium uppercase tracking-wider text-gray-400 transition-colors duration-200 hover:bg-gray-800"onClick={() => handleSort('name')}
 >
 ...
 <th
 className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200"onClick={() => handleSort('phone')}
 >
 <div className="flex items-center gap-1">
 Contact
 {getSortIcon('phone')}
 ...
 <th
 className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200"onClick={() => handleSort('degree')}
 >
 <div className="flex items-center gap-1">
 Academic
 {getSortIcon('degree')}
 ...
 <th
 className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200"onClick={() => handleSort('placement_status')}
 >
 <div className="flex items-center gap-1">
 Placement
 ...
 <th
 className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200"onClick={() => handleSort('total_applications')}
 >
 <div className="flex items-center gap-1">
 Applications
 ...
 <th
 className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200"onClick={() => handleSort('profile_completion_percentage')}
 >
 <div className="flex items-center gap-1">
 Status
 ...
 <th
 className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200"onClick={() => handleSort('created_at')}
 >
 <div className="flex items-center gap-1">
 Created
 ...
 <div className="flex h-10 w-10 items-center justify-center border border-gray-700 bg-gray-800">
 ...
 <td className="whitespace-nowrap px-6 py-5">
 <div className="text-base text-white">
 <span className={`inline-flex px-2 py-1 text-xs font-semibold ${getStatusColor(student.placement_status)}`}>
 ...
 {student.is_archived ? (
 <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold bg-orange-100 text-orange-800">
 <Archive className="w-3 h-3"/>
 Archived
 </span>
 ) : student.status?.toLowerCase() ==='inactive'? (
 <span className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold ${getStatusColor('inactive')}`}>
 Inactive
 </span>
 ) : student.status?.toLowerCase() ==='pending'? (
 <span className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold ${getStatusColor('pending')}`}>
 ...
 {/* Pagination */}
 {totalPages > 1 && (
 <div className="flex items-center justify-between border-t border-gray-700 bg-gray-800 px-4 py-4 sm:px-6">
