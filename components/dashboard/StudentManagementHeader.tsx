...
export function StudentManagementHeader({
 ...
 <Input
 type="text"placeholder="Search students by name, email, or phone..."value={searchTerm}
 ...
 className="flex items-center gap-2 border-gray-200 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
 ...
 className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 pt-4 border-t border-gray-200 overflow-hidden">
 {/* Status Filter */}
 <div>
 ...
 className="border-gray-200 hover:border-gray-300 transition-all duration-200 hover:shadow-md px-6">
