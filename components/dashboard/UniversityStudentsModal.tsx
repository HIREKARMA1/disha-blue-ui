...
const studentsList = Array.isArray(response) ? response : (response.students || [])
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 bg-black"onClick={handleClose}
 />
 ...
 <p className="text-sm text-gray-600">This university has no students yet.</p>
 </div>
 ) : (
 ...
 <th className="text-left py-3 px-4 text-sm font-medium text-gray-700">Academic</th>
 <th className="text-left py-3 px-4 text-sm font-medium text-gray-700">Placement</th>
 ...
 <div className="flex items-center space-x-3">
 <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center text-white font-semibold">
