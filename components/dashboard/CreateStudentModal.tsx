...
import Link from 'next/link'// Degree options (Full list for fallback)
...
const requestData: CreateStudentRequest = {
 ...
 <span className="text-xs sm:text-sm font-medium text-gray-900 break-all">{createdStudent?.email}</span>
 </div>
 <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
 <span className="text-xs sm:text-sm text-gray-600">Password:</span>
 <span className="text-xs sm:text-sm font-medium text-gray-900">{createdStudent?.temporary_password ||'Password@123'}</span>
 </div>
 </div>
 </div>
 ...
 <h4 className="text-xs sm:text-sm font-medium text-red-900 mb-1">
 Error
 </h4>
 ...
 <div className="text-left min-w-0">
 <h4 className="text-xs sm:text-sm font-medium text-amber-900 mb-1">
 No Active Licenses
 </h4>
 <p className="text-xs sm:text-sm text-amber-800 break-words">
 You need an active license to create student accounts. Please request a license from the administration. <Link href="/dashboard/university/licenses"onClick={onClose} className="underline font-medium hover:text-amber-900">Click here</Link> to create licenses.
 </p>
 </div>
 </div>
 </div>
 ...
 <div>
 <label htmlFor="graduation_year"className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
 Graduation Year (Batch) *
 </label>
 <div className="relative">
 <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 z-10"/>
 <input
 type="text"id="graduation_year"required
 disabled={!hasActiveLicenses}
 ...
 <div>
 <label htmlFor="degree"className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
 Degree *
 </label>
 <div className="relative">
 ...
 <div>
 <label htmlFor="branch"className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
 Branch *
 </label>
 <div className="relative">
 <GraduationCap className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 z-10"/>
