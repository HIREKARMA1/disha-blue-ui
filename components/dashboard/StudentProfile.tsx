        ...
        return (
            <StudentDashboardLayout>
                <div className="w-full text-center">
                    <div className="mx-auto max-w-md rounded-2xl border border-border bg-card p-6 shadow-soft lg:p-8">
    ...
    return (
        <StudentDashboardLayout>
            <div className="w-full">
                        ...
                        <div className="mb-6 rounded-2xl border border-border bg-gradient-to-br from-primary/[0.08] via-card to-secondary/[0.08] p-6 shadow-soft">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        {profile.resume && (
                                            <Link
                                                ...
                                                className="inline-flex items-center rounded-full border border-border bg-background px-3 py-1 text-xs font-medium text-foreground hover:bg-muted/40"
                                            >
                                                Preview Resume
                                            </Link>
                                        )}
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-6">
                                ...
                                <div className="lg:col-span-3">
                                    <div className="rounded-2xl border border-border bg-card/90 p-4 shadow-soft">
                                ...
                                <aside className="space-y-4 lg:col-span-3">
                                    ...
                                    />
                                    <div className="rounded-2xl border border-border bg-card/90 p-4 shadow-soft">
                                        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-primary">AI suggestions</p>
                                    ...
                                    <div className="rounded-2xl border border-border bg-card/90 p-4 shadow-soft">
                                        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-secondary">Next steps</p>
