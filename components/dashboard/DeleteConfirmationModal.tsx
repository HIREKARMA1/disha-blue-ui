...
export function DeleteConfirmationModal({
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 bg-black z-50 flex items-center justify-center p-4"onClick={onClose}
 >
 <motion.div
 ...
 <button
 onClick={onClose}
 className="p-2 hover:bg-gray-100 transition-colors"disabled={isDeleting}
 >
