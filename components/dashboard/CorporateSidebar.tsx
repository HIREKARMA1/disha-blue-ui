...
const handleImageError = () => {
 ...
 <h2 className="text-base font-semibold text-slate-800 dark:text-blue-50">{t(locale,'nav.recruiterNavigation')}</h2>
 <button
 type="button"
 onClick={closeMobileMenu}
 ...
 <Building2 className="h-5 w-5 text-slate-600 dark:text-blue-300" strokeWidth={1.75} />
 )}
 </div>
