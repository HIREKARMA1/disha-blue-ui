    ...
    <section className="rounded-2xl border border-border bg-card p-5 shadow-soft">
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-5">
        ...
        <label className="inline-flex items-center gap-2 rounded-xl border border-border px-3 text-sm">
          <input
            type="checkbox"
            checked={locationForm.open_to_relocation}
      ...
      <div className="mt-5 space-y-3">
        {loading ? (
          ...
          jobs.map((job) => (
            <article key={job.id} className="rounded-xl border border-border/80 bg-background/60 p-4">
              ...
              <div className="mt-3 flex gap-2">
                ...
                <Link href="/dashboard/student/jobs" className="inline-flex">
                  <Button variant="gradient" size="sm" className="rounded-lg">
                    Apply
                  </Button>
                </Link>
              </div>
