...
export function UniversityDeleteConfirmationModal({
 isOpen,
 onClose,
 onConfirm,
 universityName,
 isDeleting = false
}: UniversityDeleteConfirmationModalProps) {
 ...
 Are you sure you want to <strong>permanently delete</strong> <span className="font-semibold text-red-600">{universityName}</span>?
 </p>
 <div className="text-sm text-gray-600 space-y-1 mb-4">
 <p>• All job postings will be permanently deleted</p>
 <p>• All job applications will be lost</p>
 <p>• All student associations will be removed</p>
 <p>• All practice tests will be deleted</p>
