...
export function BulkUploadModal({
 ...
 onClose,
 onSubmit,
 mode ='students'}: BulkUploadModalProps) {
...
const headerLine = lines[0]
 ...
 const requiredColumns = mode ==='universities'? ['university_name','email','institute_type']
 : ['name','email','phone']
...
const header = ['university_name','email','institute_type','phone','address','website_url','contact_person_name','contact_designation','established_year','courses_offered',
 ]

 const rows = [
 ['ABC Institute of Technology','admin@abcit.edu','Private University','+91-9876543210','123 Tech Park Road, Bengaluru, Karnataka','https://www.abcit.edu','Dr. John Doe','Training & Placement Officer','2005','B.Tech (CSE,ECE,ME), MBA, MCA',
 ],
 ['XYZ College of Engineering','placements@xyzce.ac.in','Autonomous College','+91-9123456780','45 College Road, Pune, Maharashtra','https://www.xyzce.ac.in','Prof. Jane Smith','Head - Career Services','1998','B.E (CSE,IT,Civil), M.E',
 ],
 ]
 ...
 onClick={(e) => {
 console.log(' Content area clicked, preventing bubble')
 e.stopPropagation()
 }}
 onMouseDown={(e) => {
 console.log(' Content area mouse down, preventing bubble')
 e.stopPropagation()
 }}
 >
