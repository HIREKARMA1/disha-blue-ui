...
const handleImageError = () => {
 ...
 <aside
 className={cn(
 'fixed left-0 top-16 z-40 hidden h-[calc(100vh-4rem)] w-16 flex-col bg-blue-50 dark:bg-blue-950 lg:flex',
 'rounded-none',
 className,
 )}
 >
 ...
 <div
 className="fixed bottom-0 left-0 right-0 z-50 border-t border-blue-600 bg-blue-50 pb-safe dark:border-blue-800 dark:bg-blue-950 lg:hidden"
 ...
 >
 <div className="flex flex-shrink-0 items-center justify-between border-b border-slate-200 bg-blue-50 px-4 py-4 dark:border-blue-800 dark:bg-blue-950">
 <h2 className="text-base font-semibold text-slate-800 dark:text-blue-50">Menu</h2>
 <button
 type="button"
 onClick={closeMobileMenu}
 ...
 <User className="h-5 w-5 text-slate-600 dark:text-blue-300" strokeWidth={1.75} />
 )}
 </div>
