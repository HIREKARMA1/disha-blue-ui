...
export function StudentLockScreen({ isOpen, universityName, universityEmail, reason }: StudentLockScreenProps) {
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed top-1/2 left-[calc(50%+3rem)] transform -translate-x-1/2 -translate-y-1/2 z-50 flex items-center justify-center">
 ...
 className="p-4 bg-teal-700 hover:bg-teal-800 hover:scale-110 transition-all duration-200 cursor-pointer shadow-lg">
 ...
 className="text-sm text-gray-700 text-center font-medium max-w-md">
