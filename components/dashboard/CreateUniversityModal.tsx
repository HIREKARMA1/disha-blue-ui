...
export function CreateUniversityModal({
 ...
 const instituteTypes = ['Government','Private','Deemed University','Central University','State University','Autonomous College','Private University','Institute of National Importance']
 ...
 label="University Name *"placeholder="Search for university / college..."value={selectedCollegeId}
