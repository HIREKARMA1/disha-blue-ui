...
export function StatusDropdown({ universityId, currentStatus, onStatusChange }: StatusDropdownProps) {
 ...
 ?'bg-primary-50 text-primary-700':'text-gray-900'}`}
 >
 ...
 disabled={isUpdating}
 className={`inline-flex items-center px-2.5 py-0.5 text-xs font-medium ${getStatusColor(currentStatus)} hover:opacity-80 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed`}
 >
 {isUpdating ? (
 <>
