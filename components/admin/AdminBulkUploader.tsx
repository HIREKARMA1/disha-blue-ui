...
import { useCreateQuestion, useAddQuestionToModule } from '@/hooks/useAdminPractice'
...
export function AdminBulkUploader({ onComplete, onCancel, moduleId }: AdminBulkUploaderProps) {
