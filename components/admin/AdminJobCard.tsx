...
import { MapPin, Briefcase, Clock, DollarSign, Users, Building, Eye, FileText, Calendar, MoreVertical, Edit, Trash2, ToggleLeft, ToggleRight, UserCheck, Link2, Globe } from 'lucide-react'
...
export function AdminJobCard({ job, onViewDescription, onEdit, onDelete, onStatusChange, onViewAppliedStudents, onMakePublic, onCreateAssessment, cardIndex = 0 }: AdminJobCardProps) {
