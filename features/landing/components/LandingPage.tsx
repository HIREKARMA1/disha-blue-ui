    ...
    <div className="disha-theme">
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hl">
            <div className="h-kicker"><span className="hk-line"></span>{copy.hero.kicker}</div>
            <h1 className="h1">{copy.hero.titleLine1}<br /><em>{copy.hero.titleEm}</em><span style={{ color: '#fff' }}>{copy.hero.titleLine2}</span></h1>
            <p className="hdesc">{copy.hero.description}</p>
          ...
          <div className="hr">
            <div className="ai-dashboard">
              <div className="dash-header">
                <span className="dash-logo">{copy.hero.dashBrand}<b></b></span>
              </div>
        ...
        <div className="tick-track">
          {[1, 2].map((dup) => (
            <React.Fragment key={dup}>
              {copy.ticker.map((label) => (
                <span className="ti" key={`${dup}-${label}`}>
                  <span className="ti-sq"></span>
                  {label}
                </span>
              ))}
            </React.Fragment>
