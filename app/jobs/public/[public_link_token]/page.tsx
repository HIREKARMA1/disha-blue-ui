...
export default function PublicJobPage() {
  ...
  // Hyper-local public jobs do not require university assignment checks.
  ...
  return job.pincode ? `${base} - ${job.pincode}` : base
  }
  const structuredLocationParts = () => ({
  village_or_locality: job?.village_or_locality || null,
  city_or_town: job?.city_or_town || null,
  ...
  <span className="font-medium">{formatStructuredLocation()}</span>
  </div>
  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
  ...
  {/* Structured Locality Snapshot */}
  <div className="mt-2 p-4 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-xl">
  <p className="text-sm font-semibold text-primary-800 dark:text-primary-200 mb-3">
  Hyper-local location details
  </p>
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
  <div className="text-xs">
  <p className="text-gray-500 dark:text-gray-400">Village / Locality</p>
  <p className="font-medium text-gray-900 dark:text-white">{structuredLocationParts().village_or_locality || '-'}</p>
  </div>
  <div className="text-xs">
  <p className="text-gray-500 dark:text-gray-400">City / Town</p>
  <p className="font-medium text-gray-900 dark:text-white">{structuredLocationParts().city_or_town || '-'}</p>
  </div>
  <div className="text-xs">
  <p className="text-gray-500 dark:text-gray-400">District</p>
  <p className="font-medium text-gray-900 dark:text-white">{structuredLocationParts().district || '-'}</p>
  </div>
  <div className="text-xs">
  <p className="text-gray-500 dark:text-gray-400">State</p>
  <p className="font-medium text-gray-900 dark:text-white">{structuredLocationParts().state || '-'}</p>
  </div>
  <div className="text-xs">
  <p className="text-gray-500 dark:text-gray-400">Pincode</p>
  <p className="font-medium text-gray-900 dark:text-white">{structuredLocationParts().pincode || '-'}</p>
  </div>
  </div>
  </div>
  ...
  {/* Action Buttons Card */}
  <div className="bg-card rounded-2xl border border-border p-6 sticky top-6 shadow-soft">
  ...
  className="w-full bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white disabled:bg-muted disabled:cursor-not-allowed shadow-medium hover:shadow-large transition-all duration-200 transform hover:scale-[1.02]"
  size="lg"
  title={
  hasApplied
  ...
  <div className="relative w-full share-dropdown-container">
  <Button
  variant="outline"
  ...
  {showShareDropdown && (
  <div
  className="absolute top-full left-0 mt-2 w-full bg-popover rounded-lg border border-border shadow-medium z-50 py-2"
  ...
  className={`relative py-4 px-6 font-semibold text-sm transition-all duration-200 ${activeTab === 'description'
  ...
  className={`relative py-4 px-6 font-semibold text-sm transition-all duration-200 ${activeTab === 'company'
  ? 'text-primary-600 dark:text-primary-400'
  : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
  }`}
  >
