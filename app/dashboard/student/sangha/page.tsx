...
export default function SanghaPage() {
 ...
 <div className="animate-spin h-8 w-8 border-b-2 border-violet-600 mx-auto mb-4"></div>
 ...
 <div className="p-3 rounded-none-none">
 ...
 <CardContent>
 <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-none-none">
