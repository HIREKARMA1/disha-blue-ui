...
export default function UniversityStudents() {
 ...
 setError(null)
 try {
 const response = await legacyUniversityApi.getUniversityStudents(includeArchived)
...
const matchesArchiveStatus = includeArchived ? student.is_archived : !student.is_archived
 ...
 const result = await legacyUniversityApi.createStudent(studentData)
 ...
 try {
 await legacyUniversityApi.uploadStudentsCSV(file)
 ...
 try {
 await legacyUniversityApi.archiveStudent(studentId, archive)
 ...
 try {
 await legacyUniversityApi.deleteStudent(studentId)
 ...
 className="rounded-none-none p-6 border border-primary-200">
 ...
 className="inline-flex items-center px-3 py-1 text-sm font-medium bg-primary-100 text-primary-800 hover:bg-primary-200 transition-colors cursor-pointer">
 ...
 className="inline-flex items-center px-3 py-1 text-sm font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors cursor-pointer">
 ...
 className="inline-flex items-center px-3 py-1 text-sm font-medium bg-orange-100 text-orange-800 hover:bg-orange-200 transition-colors cursor-pointer">
 ...
 className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-none-none shadow-md hover:bg-blue-700 transition-colors">
 ...
 className="flex items-center px-4 py-2 bg-green-600 text-white rounded-none-none shadow-md hover:bg-green-700 transition-colors">
 ...
 className="flex items-center px-4 py-2 bg-orange-600 text-white rounded-none-none shadow-md hover:bg-orange-700 transition-colors">
