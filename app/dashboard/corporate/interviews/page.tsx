...
export default function CorporateInterviewsPage() {
 ...
 <p className="mb-2 text-xs font-semibold uppercase tracking-wider">Coordination</p>
 ...
 <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-none-none text-secondary-foreground">
