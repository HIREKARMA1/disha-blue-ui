...
export default function CorporateSettingsPage() {
 ...
 <p className="mb-2 text-xs font-semibold uppercase tracking-wider">Workspace</p>
 ...
 <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-none-none bg-muted text-muted-foreground">
