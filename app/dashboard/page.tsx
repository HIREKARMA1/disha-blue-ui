                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">Welcome to {BRANDING.appName}</p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-4">
                            <ThemeToggle />
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">Discover nearby opportunities</p>
                                </div>
                            </div>
                        </div>
                    </div>
