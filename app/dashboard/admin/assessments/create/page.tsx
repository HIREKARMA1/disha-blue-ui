...
export default function CreateAssessmentPage() {
 ...
 {/* Header Section */}
 {/* Header Section */}
 <div className="bg-white rounded-none-none p-6 border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
 <div>
 ...
 mode="create"initialData={initialData}
 />
 </div>
 </AdminDashboardLayout>
 )
