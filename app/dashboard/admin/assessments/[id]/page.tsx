...
const copyToClipboard = () => {
 ...
 <div className="bg-yellow-50 border border-yellow-200 rounded-none-none p-6">
 ...
 <div className="bg-white rounded-none-none shadow p-4">
 ...
 {/* Statistics */}
 {stats && (
 <div className="bg-white rounded-none-none shadow p-6">
 ...
 <div key={index} className="border border-gray-200 rounded-none-none p-4">
 ...
 <input
 type="text"value={studentEmail}
 onChange={(e) => setStudentEmail(e.target.value)}
 placeholder="Enter student email or ID"className="w-full px-4 py-2 border border-gray-300 rounded-none-none focus:ring-2 focus:ring-blue-500 outline-none"disabled={isGeneratingToken}
 />
 </div>
 <Button
 type="submit"disabled={isGeneratingToken || !studentEmail}
 ...
 <p className="text-sm font-mono bg-white p-2 rounded-none border border-gray-300 break-all">
 ...
 <Button
 variant="outline"size="sm"onClick={copyToClipboard}
 className="flex items-center gap-2">
 <Copy size={16} />
 {copiedToken ?'Copied!':'Copy'}
 </Button>
 </div>
 <p className="text-xs font-mono bg-white p-2 rounded-none border border-gray-300 break-all max-h-20 overflow-y-auto">
