...
const formattedData = {
 ...
 <AdminDashboardLayout>
 <div className="flex h-[calc(100vh-200px)] items-center justify-center">
 <div className="text-center max-w-md p-8 bg-red-50 border border-red-100 rounded-none-none">
 ...
 {/* Header Section */}
 <div className="rounded-none-none p-6 border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-10">
 <div>
