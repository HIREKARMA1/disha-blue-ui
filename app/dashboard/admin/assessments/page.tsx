...
const filteredAssessments = assessments.filter(assessment => {
 ...
 {/* Header Section */}
 <div className="rounded-none-none p-6 border border-purple-200">
 ...
 <Button className="bg-purple-600 hover:bg-purple-700 text-white shadow-md hover:shadow-lg transition-all flex items-center gap-2 h-11 px-6 rounded-none-none">
 ...
 {/* Filters Section */}
 <div className="grid grid-cols-1 md:grid-cols-12 gap-4 bg-white p-4 rounded-none-none shadow-sm border border-gray-100">
 <div className="md:col-span-6 lg:col-span-8">
 <div className="relative">
 <input
 type="text"placeholder="Search assessments..."value={filters.search}
 onChange={(e) => setFilters({ ...filters, search: e.target.value })}
 className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-none-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all placeholder:text-gray-400"/>
 ...
 className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-none-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-sm">
 ...
 {/* Error State */}
 {error && !isLoading && (
 <div className="bg-red-50 border border-red-200 rounded-none-none p-4 flex items-center gap-3 text-red-700">
