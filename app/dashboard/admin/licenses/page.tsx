...
const stats = {
 ...
 {/* Tabs */}
 <div className="flex space-x-1 bg-gray-100 p-1 rounded-none-none self-start md:self-auto">
 <button
 onClick={() => setActiveTab('requests')}
 className={`px-4 py-2 rounded-none-none text-sm font-medium transition-all duration-200 flex items-center gap-2 ${activeTab ==='requests'?'bg-white text-primary-600 shadow-sm':'text-gray-600 hover:text-gray-900'}`}
 >
 <FileText className="w-4 h-4"/>
 Requests
 {requests.filter(r => r.status ==='pending').length > 0 && (
 <span className="bg-yellow-100 text-yellow-800 text-xs font-bold px-1.5 py-0.5 ml-1">
 ...
 className={`px-4 py-2 rounded-none-none text-sm font-medium transition-all duration-200 flex items-center gap-2 ${activeTab ==='licenses'?'bg-white text-primary-600 shadow-sm':'text-gray-600 hover:text-gray-900'}`}
 >
 ...
 className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-none-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 bg-white text-sm"/>
 </div>
 ...
 className="w-full sm:w-auto pl-4 pr-10 py-2 border border-gray-200 rounded-none-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 bg-white text-sm appearance-none cursor-pointer">
 ...
 whileTap={{ scale: 0.98 }}
 onClick={loadData}
 className="px-4 py-2 bg-white border border-gray-200 rounded-none-none text-gray-600 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 text-sm font-medium shadow-sm">
