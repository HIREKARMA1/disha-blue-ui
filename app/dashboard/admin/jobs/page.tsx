        ...
        <AdminDashboardLayout>
            <div className="space-y-6 main-content">
                ...
                <motion.div
                    ...
                    className="rounded-2xl border border-border bg-gradient-to-br from-primary/[0.08] via-card to-secondary/[0.08] p-6 shadow-soft"
                >
                ...
                {/* Search and Filters */}
                <div className="rounded-2xl border border-border bg-card/80 p-5 shadow-soft relative overflow-visible layout-stable">
                    {/* Search Bar */}
                    <div className="flex flex-col lg:flex-row gap-4 mb-4">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <Input
                                    type="text"
                                    placeholder={tf(locale, 'admin.jobs.searchPlaceholder', 'Search by title, keyword, location, or employer...')}
                                    value={searchTerm}
                ...
                {/* Results Summary */}
                <div className="mb-6 rounded-2xl border border-border bg-card/80 p-4 shadow-soft">
                ...
                {loading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[...Array(6)].map((_, index) => (
                            <div key={index} className="rounded-2xl border border-border bg-card/80 p-6 animate-pulse">
                                ...
                                <div className="rounded-xl border border-border bg-card/80 p-4 shadow-soft">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Button
                                            ...
                                            className="px-3 py-2 border-border hover:border-primary/30 transition-all duration-200 hover:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            ←
                                        </Button>
                                                    ...
                                                    return (
                                                        <Button
                                                            ...
                                                            className={`min-w-[32px] h-8 ${isCurrentPage
                                                                ...
                                                                : 'border-border hover:border-primary/30 transition-all duration-200 hover:shadow-sm'
                                                                }`}
                                                        >
                                                            {pageNum}
                                                        </Button>
