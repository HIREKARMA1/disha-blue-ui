            ...
            >
                {currentStep === 'form' && (
                    <div className="mb-8 space-y-3 text-center sm:text-left">
                        ...
                        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-secondary-500 shadow-lg shadow-primary/25 sm:mx-0">
                            {(() => {
