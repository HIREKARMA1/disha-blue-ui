...
export default function ForgotPasswordPage() {
  ...
  <div className="flex h-12 w-12 items-center justify-center rounded-none border border-sage-deep/30 bg-sage-deep text-white shadow-none dark:border-emerald-600 dark:bg-emerald-700">
