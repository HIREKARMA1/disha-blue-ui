...
export default function SignupStep4Page() {
  ...
  return (
    ...
    >
      <Input className="rounded-xl border border-border bg-background px-4 py-3 text-base transition-all duration-200 ease-in-out focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary" placeholder="Type: work / internship / training" value={type} onChange={(e) => setType(e.target.value)} />
      <Input className="rounded-xl border border-border bg-background px-4 py-3 text-base transition-all duration-200 ease-in-out focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary" placeholder="Duration (e.g. 2 years)" value={duration} onChange={(e) => setDuration(e.target.value)} />
      <Input className="rounded-xl border border-border bg-background px-4 py-3 text-base transition-all duration-200 ease-in-out focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary" placeholder="Company (optional)" value={company} onChange={(e) => setCompany(e.target.value)} />
      <div className="space-y-1">
        <div className="relative">
          <textarea
            className="min-h-[96px] w-full rounded-xl border border-border bg-background px-4 py-3 pr-12 text-base text-foreground transition-all duration-200 ease-in-out focus-visible:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
