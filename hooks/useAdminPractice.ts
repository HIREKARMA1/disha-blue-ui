...
export function useAdminPracticeModules(
  ...
  const response = await apiClient.client.get(`/practice/admin/modules?${params.toString()}`)
...
export function useCreatePracticeModule() {
  ...
  const response = await apiClient.client.post('/practice/admin/modules', moduleData)
...
export function useAdminQuestions(moduleId?: string) {
  ...
  const response = await apiClient.client.get(`/practice/admin/modules/${moduleId}/questions`)
...
export function useCreateQuestion() {
  ...
  const response = await apiClient.client.post('/practice/admin/questions', questionData)
  return response.data
  } catch (err) {
...
export function useUpdateQuestion() {
  ...
  const response = await apiClient.client.put(`/practice/admin/questions/${questionId}`, questionData)
  return response.data
  } catch (err) {
...
export function useDeleteQuestion() {
  ...
  await apiClient.client.delete(`/practice/admin/questions/${questionId}`)
  } catch (err) {
...
export function useAddQuestionToModule() {
  ...
  await apiClient.client.post(`/practice/admin/modules/${moduleId}/questions/${questionId}`)
  } catch (err) {
...
export function useRemoveQuestionFromModule() {
  ...
  await apiClient.client.delete(`/practice/admin/modules/${moduleId}/questions/${questionId}`)
  } catch (err) {
